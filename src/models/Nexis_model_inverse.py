...
class run_Nexis:
    def __init__(self,C_,U_,t_vec_,w_dir_=0,volcorrect_=0,region_volumes_=[],  logistic_term_=0):
    ...
    def simulate_nexis(self, parameters):
        ...
        else: # Run exponential forward model
    ...
    def logistic(self,t_,x0_,A_,Gamma_,k_):
        ...
        sol = odeint(ode_func, y0, t_, args=(A_,Gamma_,k_),rtol=1e-3, atol=1e-6)
